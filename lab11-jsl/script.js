...
console.log("%c🔹 The first number is: " + num1, "color: orange;");
console.log("%c🔹 The second number is: " + num2, "color: orange;");

console.log("%c➕ Sum: " + sum, "color: green;");
console.log("%c➖ Difference: " + difference, "color: red;");
